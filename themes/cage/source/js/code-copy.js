window.addEventListener('DOMContentLoaded', () => {
	...
	const addCopyButton = function (codeBlock) {
		...
		copyWrapper.setAttribute('class', 'cage-codeblock-copy-wrapper');
		...
		copyWrapper.addEventListener('click', (ev) => {
			...
			navigator.clipboard
				...
				.then(() => {
					...
					copyWrapper.classList.add('cage-codeblock-copy-wrapper-copied');
					copiedTimeout = setTimeout(() => {
						copyWrapper.classList.remove('cage-codeblock-copy-wrapper-copied');
						copiedTimeout = null;
					}, 1500);
				});
		});
